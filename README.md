...
- throwOnInvalidQuery: Whether to reject the promise if the query has invalid qualifiers or not, defaults to `true` (if `false`, invalid qualifiers will be removed from `q`)
